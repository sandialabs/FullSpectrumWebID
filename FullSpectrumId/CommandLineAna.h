#ifndef CommandLineAna_h
#define CommandLineAna_h
...
{
/** Runs the analysis user specified on the command line.
 */
  int run_analysis( std::vector<std::string> args );
}//namespace CommandLineAna


#endif //CommandLineAna_h
